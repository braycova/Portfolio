  ...
  return (
    <div className="">
      <div className="flex lg:justify-center mb-3">
        <a href="#"><Image src={"/Profile.jpg"} alt={"My profile image"} width={200} height={200}
      ...
      <p className="mt-2 opacity-80">An up-and-coming software developer from southeastern Iowa.</p>
    </div>
  )
}