...
export default function Contact() {
  return (
    <nav className="pt-2 text-3xl" aria-label="Email and Social Links">
      ...
      <a href="https://github.com/braycova" target="_blank" title="GitHub" className="hover:text-gray-500 transition"><FontAwesomeIcon icon={faGithub} className="fa-fw"/></a>
