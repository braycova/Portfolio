...
export default function Skills() {
  const Item = ({imageUrl, name, description}: {imageUrl: string, name: string, description: string}) => {
    return (
      <div className="bg-gray-800 border-1 border-gray-700 rounded-lg flex p-3">
        <Image src={imageUrl} alt={name} width={50} height={50} className="rounded-lg object-contain" />
